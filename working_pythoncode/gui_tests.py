...
class GuiTests(unittest.TestCase):
    ...
    def test_switch_stop_playback(self):
        sol = gui_utils.switch_stop_playback()
    ...
    def test_switch_pause_playback(self):
        sol = gui_utils.switch_pause_playback()
    ...
    def test_get_abs_pos_zero(self):
        res = [170, 170]
        solx, soly = gui_utils.get_abs_pos(90, 0)
    ...
    def test_get_abs_pos_float(self):
        res = [170, 170]
        solx, soly = gui_utils.get_abs_pos(1.0, 0)
    ...
    def test_get_abs_pos(self):
        res = [170, 270]
        solx, soly = gui_utils.get_abs_pos(180, 100)
